...
# def get_user_number(msg, count): модуль,
...
# Если принять, что номер куста = количество яг
...
# которое может собрать за один заход собирающийод на кусте, то максимальное число ягод
